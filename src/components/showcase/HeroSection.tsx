    ...
    <section className="py-32 px-6 relative overflow-hidden">
      ...
      <div className="container max-w-5xl mx-auto text-center relative z-10">
        ...
        <h1 className="text-5xl md:text-7xl font-bold mb-8 leading-tight">
          <span className="bg-gradient-to-br from-white via-sky-100 to-indigo-400 bg-clip-text text-transparent">
        ...
        {/* Subtitle */}
        <p className="text-xl md:text-2xl/7 text-gray-50/50 mb-8 max-w-3xl mx-auto font-light tracking-tigher">
